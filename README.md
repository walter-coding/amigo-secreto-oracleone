...
Otra característica propia de esta funcionalidad es que admite nombres compuestos. Si los nombres no tienen caracteres no válidos, y el usuario final considera que está listo para formar parte de la lista de amigos, luego de presionar **ENTER** o hacer click en el botón **Añadir** debajo del campo de ingreso de nombres aparece un listado con los nombres de sus amigos:

![imagen que muestra el listado de amigos ingresados](./assets/funcionalidad2a.png)
